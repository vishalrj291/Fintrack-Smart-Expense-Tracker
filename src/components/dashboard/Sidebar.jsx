    ...
    <>
      ...
      >
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px' }}>
          <p style={{ fontSize: '11px', fontWeight: 600, color: '#4b5563', textTransform: 'uppercase', letterSpacing: '0.1em', padding: '8px 16px' }}>
            Main Menu
          </p>
          ...
          <p style={{ fontSize: '11px', fontWeight: 600, color: '#4b5563', textTransform: 'uppercase', letterSpacing: '0.1em', padding: '8px 16px', marginTop: '16px' }}>
            Tools
          </p>
